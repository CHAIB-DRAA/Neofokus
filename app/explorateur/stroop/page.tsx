  ...
  return (
    <div className="space-y-4">
      <div className="rounded-3xl p-5" style={{ background: "linear-gradient(135deg, #E8E0F8, #FDECEA)" }}>
        ...
        <div className="font-display text-xl font-extrabold text-[#3D1F8A]">Défi des Couleurs</div>
        <div className="text-xs text-[#4A5568] font-semibold mt-1">Effet Stroop × Inhibition cognitive</div>
      </div>
