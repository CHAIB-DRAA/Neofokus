  ...
  return (
    <div className="space-y-4">
      <div className="rounded-3xl p-5" style={{ background: "linear-gradient(135deg, #FFF9C4, #FFE0B2)" }}>
        ...
        <div className="font-display text-xl font-extrabold text-[#9C4400]">The Great Scale</div>
        <div className="text-xs text-[#7A5C00] font-semibold mt-1">{t("mizan.subtitle")}</div>
      </div>
