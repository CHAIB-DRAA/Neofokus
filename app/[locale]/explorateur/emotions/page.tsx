  ...
  return (
    <div className="space-y-4">
      <div className="rounded-3xl p-5" style={{ background: "linear-gradient(135deg, #B8EDD9, #FFF9C4)" }}>
        ...
        <div className="font-display text-xl font-extrabold text-[#0F5C3A]">Emotion Detective</div>
        <div className="text-xs text-[#4A5568] font-semibold mt-1">{t("emotions.subtitle")}</div>
      </div>
