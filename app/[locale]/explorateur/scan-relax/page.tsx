  ...
  return (
    <div className="space-y-4">
      <div className="rounded-3xl p-5" style={{ background: "linear-gradient(135deg, #BFE3F5, #B8EDD9)" }}>
        ...
        <div className="font-display text-xl font-extrabold text-[#1A5F7A]">Body Scan</div>
        <div className="text-xs text-[#4A5568] font-semibold mt-1">{t("scan-relax.subtitle")}</div>
      </div>
