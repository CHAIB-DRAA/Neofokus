  ...
  return (
    <div className="space-y-4">
      <div className="rounded-3xl p-5" style={{ background: "linear-gradient(135deg, #FDECEA, #FFF9C4)" }}>
        ...
        <div className="font-display text-xl font-extrabold text-[#C02020]">Opposites Express</div>
        <div className="text-xs text-[#7A4200] font-semibold mt-1">{t("contraires.subtitle")}</div>
      </div>
